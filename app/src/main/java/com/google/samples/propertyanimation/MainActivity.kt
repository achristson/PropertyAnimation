...
class MainActivity : AppCompatActivity() {
    ...
    private fun colorizer() {
        val animator : ObjectAnimator = ObjectAnimator.ofArgb(star.parent, "backgroundColor",
    ...
    private fun shower() {
        ...
        val mover : ObjectAnimator = ObjectAnimator.ofFloat(newStar,
                View.TRANSLATION_Y, -starH, containerH + starH)
        mover.interpolator = AccelerateInterpolator(1f)

        val rotator : ObjectAnimator = ObjectAnimator.ofFloat(newStar,
